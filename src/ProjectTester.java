...
public interface ProjectTester {
    ...
    This method must return a list of objects that implement the com.example.final_project.SearchResult interface.
    The list should return the top X search results for the given query/boost values.
    The list should be sorted from the highest search score to lowest.
